    ...
    return (
        <div className='bg-white fixed top-0 w-[100%] z-10'>
            <div className='container mx-auto flex justify-between items-center py-4 px-4'>
                ...
                <a href='#download'
                    className='hidden md:flex border border-[#ff4D41] px-4 py-1 text-[18px] text-[#ff4D41] 
                    rounded-[5px] item-center gap-2 hover:bg-[#ff4D41] hover:text-white transition duration-200 '>
                    Download CV
                    <AiOutlineDownload />
                </a>
